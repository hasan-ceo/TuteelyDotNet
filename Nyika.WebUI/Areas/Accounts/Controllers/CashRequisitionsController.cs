...
namespace Nyika.WebUI.Areas.Accounts.Controllers
{
    ...
    public class CashRequisitionsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(db.CashRequisition(instanceId));
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Approve(long CashRequisitionID)
        {
            
                
                CashRequisition cashRequisition = db.Single(instanceId, CashRequisitionID);
                if (cashRequisition == null)
                {
                    return RedirectToAction("Index");
                }
                db.ApproveCashRequisition(cashRequisition.CashRequisitionID, User.Identity.Name);
                return RedirectToAction("Index");
